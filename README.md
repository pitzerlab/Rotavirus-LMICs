...
If analysis of a specific country is required, configure the icountry loop accordingly.

Use icountry_order.xlsx to identify the country corresponding to each icountry value.
